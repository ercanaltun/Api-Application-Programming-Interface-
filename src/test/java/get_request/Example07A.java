...
public class Example07A extends JsonplaceholderBaseUrl {
    ...
    public void test07A() {
        ...
        //3.Step:Send The qouest and Get the Response
       ...
       //1)Status code is 200 == > Status kodu 200 olmali
        ...
        List<Integer>idler=json.getList("findAll{it.id>190}.id"); //Groovy Language
        System.out.println("Id'si 190'dan buyuk olanlar listesi :"+idler);
